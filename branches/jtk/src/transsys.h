...
extern SYMBOL_INSTANCE *new_symbol_instance(const LSYS *lsys, int symbol_index);
...
extern int string_transsys_expression(SYMBOL_INSTANCE *symbol_string);
extern SYMBOL_INSTANCE *axiom_string(const LSYS *lsys);
extern SYMBOL_INSTANCE *derived_string(const LSYS *lsys, const SYMBOL_INSTANCE *source_string);
